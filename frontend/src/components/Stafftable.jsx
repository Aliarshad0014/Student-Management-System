  ...
  return (
    <div>
      <div className="flex justify-end">
        <Link to="/add-staff" className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded mb-4">
          Add Staff +
        </Link>
      </div>
            ...
            <tr key={index} className='bg-white'>
              ...
              <td className="border px-4 py-2">
                <div className="flex justify-around">
                  <Link to="/update-staff" className="ml-2 px-2 py-1 bg-blue-500 hover:bg-blue-600 text-white rounded">Update</Link>
